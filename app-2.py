...
st.markdown("---")
st.caption("Group 8 — TBS Education | EL MIR Otmane • SAVOYE Raphael • MOUMNI Youssef | Amazon Product Reviews | 20,000 reviews | 3 Recommendation Models")    position: relative;
    overflow: hidden;
}
.hero::before {
    content: "";
